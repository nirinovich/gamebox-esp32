...
**RoomLifecycle**:
The lifecycle states of a Room: WAITING (open for Challengers), ACTIVE (authoritative game execution in progress), FINISHED (outcome resolved), and DISSOLVED (cleaned up and unmapped).
_Avoid_: Status, Phase, State
